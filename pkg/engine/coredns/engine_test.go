...
var _ engine.Engine = (*CoreDNSEngine)(nil)

func TestNewCoreDNSEngine(t *testing.T) {
	e := NewCoreDNSEngine(t.TempDir())
	if e == nil {
		t.Fatal("NewCoreDNSEngine() returned nil")
	}
}

func TestCoreDNSEngineConfigureWritesConfig(t *testing.T) {
	configDir := t.TempDir()
	e := NewCoreDNSEngine(configDir)
	...
	expectedPath := filepath.Join(configDir, "Corefile")
...
func TestCoreDNSEngineStartRequiresConfiguration(t *testing.T) {
	e := NewCoreDNSEngine(t.TempDir())
...
func TestCoreDNSEngineReloadNoop(t *testing.T) {
	e := NewCoreDNSEngine(t.TempDir())
...
func TestCoreDNSEngineStopWithoutProcess(t *testing.T) {
	e := NewCoreDNSEngine(t.TempDir())
...
func TestCoreDNSEngineHealthCheck(t *testing.T) {
...
func TestCoreDNSEngineName(t *testing.T) {
	e := NewCoreDNSEngine(t.TempDir())
	if got := e.Name(); got != engine.EngineCoreDNS {
		t.Fatalf("expected Name() = %q, got %q", engine.EngineCoreDNS, got)
	}
}
